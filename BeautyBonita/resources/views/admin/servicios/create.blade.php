...
<head>
    ...
    <title>Crear Servicio - Beauty Bonita</title>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="card">
            <div class="p-6 border-b">
                <h2 class="text-2xl font-light text-gray-800">Crear Nuevo Servicio</h2>
            </div>

            <form action="{{ route('admin.servicios.store') }}" method="POST" enctype="multipart/form-data" class="p-6">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <textarea id="descripcion" name="descripcion" rows="3" 
                              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-gray-300" required>{{ old('descripcion') }}</textarea>
                    @error('descripcion')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <input type="number" id="duracion_minutos" name="duracion_minutos" value="{{ old('duracion_minutos') }}" 
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-gray-300" required>
                    ...
                    <div>
                        ...
                        <input type="number" id="descuento" name="descuento" step="0.01" min="0" max="100" value="{{ old('descuento') }}" 
                ...
                <div class="mb-6">
                    ...
                    <textarea id="caracteristicas" name="caracteristicas" rows="2" 
                              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-gray-300">{{ old('caracteristicas') }}</textarea>
