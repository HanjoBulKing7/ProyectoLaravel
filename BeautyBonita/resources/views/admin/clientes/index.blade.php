...
<head>
    ...
    <!-- CSS personalizado -->
    <link rel="stylesheet" href="{{ asset('css/ClientesAdmin.css') }}">
</head>
<body class="bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center">
                    ...
                    <span class="text-lg font-medium"> Admin Clientes </span>
                </div>
                ...
                <div class="hidden md:flex items-center space-x-1">
                    ...
                    <a href="{{ url('/admin/clientes') }}" class="nav-item active px-4 py-2 flex items-center">
    ...
    <div id="mobile-menu" class="hidden md:hidden bg-white shadow-lg">
        <div class="px-2 pt-2 pb-3 space-y-1">
            ...
            <a href="{{ url('/admin/clientes') }}" class="block px-3 py-2 rounded-md text-base font-medium bg-gray-100 text-gray-900">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
            <div>
                <h1 class="text-2xl font-light text-gray-800">Gestión de Clientes</h1>
                <p class="text-gray-500 mt-1">Administra los clientes de tu salón</p>
            </div>
        ...
        <div class="card overflow-hidden">
            ...
            <div class="p-4 border-b flex flex-col md:flex-row md:items-center justify-between">
                <div class="relative mb-4 md:mb-0">
                    ...
                    <input type="text" placeholder="Buscar clientes..." class="pl-10 pr-4 py-2 w-full md:w-64 rounded-md border border-gray-300 focus:outline-none focus:ring-1 focus:ring-gray-300">
                </div>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Citas</th>
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="font-medium text-gray-900">Laura Sánchez</div>
                                        <div class="text-sm text-gray-500">laura@example.com</div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">55 1234 5678</div>
                                <div class="text-sm text-gray-500">Ciudad de México</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="font-medium text-gray-900">Ana Rodríguez</div>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <div class="text-sm text-gray-500">Estado de México</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-500">22/06/2023</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="font-medium text-gray-900">Carla Méndez</div>
                                        <div class="text-sm text-gray-500">carla@example.com</div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-500">10/04/2023</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
    ...
    <div id="clientModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full hidden flex items-center justify-center">
        <div class="bg-white rounded-lg shadow-xl w-full max-w-md mx-4">
            <div class="flex justify-between items-center p-4 border-b">
                <h3 class="text-lg font-medium text-gray-800">Agregar Nuevo Cliente</h3>
            ...
            <form class="p-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="email" id="email" name="email" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-gray-300">
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input type="date" id="fecha_nacimiento" name="fecha_nacimiento" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-gray-300">
                </div>
                ...
                <div class="flex justify-end space-x-3 pt-4 border-t">
                    ...
                    <button type="submit" class="btn-primary text-white px-4 py-2 rounded-md">Guardar Cliente</button>
                </div>
            </form>
        </div>
    </div>
    ...
    <!-- JS personalizado -->
    <script src="{{ asset('js/ClientesAdmin.js') }}" defer></script>
</body>
</html>